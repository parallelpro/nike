...
#             rootpath+"sample/sharpness/perturb_gif_tnu/dnu_feh/3/",
#             rootpath+"sample/sharpness/perturb_gif_tnu/dnu_feh/4/",
...
#             rootpath+"sample/sharpness/perturb_gif_tnu/dnu_mass/3/",
#             rootpath+"sample/sharpness/perturb_gif_tnu/dnu_mass/4/"]
# for filepath in filepaths:
#     plot_slope_scatter(filepath, distance="vertical", diagram="tnu")

filepath = rootpath+"sample/sharpness/perturb_gif_tnu/dnu_feh/"
plot_scatter_zvalue(filepath, distance="vertical", diagram="tnu", iferr=True)
