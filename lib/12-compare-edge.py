if __name__ == "__main__":
        ...
        moddir = rootpath+"sample/padova_err/"
        ...
        filepath = rootpath+"sample/sharpness/padova_err/numax/perturb/"
        ...
        filepath = rootpath+"sample/sharpness/padova_err/numax/rescale/"
        if not os.path.exists(filepath): os.mkdir(filepath)
        ...
        filepath = rootpath+"sample/sharpness/padova_err/dnu/perturb/"
        if not os.path.exists(filepath): os.mkdir(filepath)
        sharpness_fit_perturb_mcmc(xobs, yobs, edges_obs, tck_obs, tp_obs,
                xpdv, ypdv, edges_pdv, tck_pdv, tp_pdv,
                diagram, distance, hist_model, filepath, ifmcmc=True)
        ...
        filepath = rootpath+"sample/sharpness/padova_err/dnu/rescale/"
        if not os.path.exists(filepath): os.mkdir(filepath)
        ...
        filepath = rootpath+"sample/sharpness/padova_err/mass/perturb/"
        if not os.path.exists(filepath): os.mkdir(filepath)
        sharpness_fit_perturb_mcmc(xobs, yobs, edges_obs, tck_obs, tp_obs,
                xpdv, ypdv, edges_pdv, tck_pdv, tp_pdv,
                diagram, distance, hist_model, filepath, ifmcmc=True)
        ...
        filepath = rootpath+"sample/sharpness/padova_err/mass/rescale/"
        if not os.path.exists(filepath): os.mkdir(filepath)
        sharpness_fit_rescale_mcmc(xobs, yobs, e_xobs, edges_obs, tck_obs, tp_obs,
                xpdv, ypdv, edges_pdv, tck_pdv, tp_pdv,
                diagram, distance, hist_model, filepath, ifmcmc=True)
        ...
        filepath = rootpath+"sample/sharpness/padova_err/radius/perturb/"
        if not os.path.exists(filepath): os.mkdir(filepath)
        sharpness_fit_perturb_mcmc(xobs, yobs, edges_obs, tck_obs, tp_obs,
                xpdv, ypdv, edges_pdv, tck_pdv, tp_pdv,
                diagram, distance, hist_model, filepath, ifmcmc=True)
        ...
        filepath = rootpath+"sample/sharpness/padova_err/radius/rescale/"
        if not os.path.exists(filepath): os.mkdir(filepath)
        sharpness_fit_rescale_mcmc(xobs, yobs, e_yobs, edges_obs, tck_obs, tp_obs,
                xpdv, ypdv, edges_pdv, tck_pdv, tp_pdv,
                diagram, distance, hist_model, filepath, ifmcmc=True)
